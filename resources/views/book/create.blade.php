    ...
    <div class="py-14 ">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="rounded px-8 pt-6 pb-8 mb-4" action="{{ route('books.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="title" name="title" type="text" maxlength="250" value="{{ old('title') }}"
                            required>
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description"
                            ...
                            name="description" rows="4" cols="50" maxlength="1000">{{ old('description') }}</textarea>
                        @error('description')
                            <x-error-message type="error" :message="$message" />
                        @enderror
                    </div>
