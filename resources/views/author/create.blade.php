            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="rounded px-8 pt-6 pb-8 mb-4" action="{{ route('authors.store') }}" method="POST">
                    ...
                    {{-- <div class="mb-4">
                        ...
                        <p class="text-gray-600 text-xs italic mt-2">Format: DD/MM/YYYY</p>
                    </div> --}}
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input datepicker type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-10 p-2.5"
                                id="birthdate" name="birthdate" placeholder="Select date">
                        </div>
                    </div>
