                ...
                <form class="rounded px-8 pt-6 pb-8 mb-4" action="{{ route('authors.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="name" name="name" type="text" maxlength="80" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="lastname" name="lastname" type="text" maxlength="80" value="{{ old('lastname') }}" required>
                        @error('lastname')
                            <x-error-message type="error" :message="$message" />
                        @enderror
                    </div>
